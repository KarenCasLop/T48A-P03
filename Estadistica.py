...
Original file is located at
    https://colab.research.google.com/drive/1CB9xqjb7KEyLBm1SpHXj0TAG63pQrE_l
"""
...
#Media de los datos de altura
mean_height = np.mean(altura);
print(f"Media de las alturas: {mean_height}")

# Mediana de los datos de altura
median_height = np.median(altura)
print(f"Mediana de las alturas: {median_height}")

# Desviación estándar de los datos de altura
std_dev_height = np.std(altura)
print(f"Desviación estándar de las alturas: {std_dev_height}")

# Varianza de los datos de altura
variance_height = np.var(altura)
print(f"Varianza de las alturas: {variance_height}")

# Máximo y mínimo de los datos de altura
max_val_height = np.max(altura)
min_val_height = np.min(altura)
print(f"Máximo de las alturas: {max_val_height}, Mínimo de las alturas: {min_val_height}")

# Percentiles de los datos de altura
percentile_25_height = np.percentile(altura, 25)
percentile_75_height = np.percentile(altura, 75)
print(f"Percentil 25 de las alturas: {percentile_25_height}, Percentil 75 de las alturas: {percentile_75_height}")
...
#Media de los datos de cintura
mean_waist = np.mean(cintura);
print(f"Media de los datos de la cintura: {mean_waist}")

# Mediana de los datos de cintura
median_waist = np.median(cintura)
print(f"Mediana de los datos de la cintura: {median_waist}")

# Desviación estándar de los datos de cintura
std_dev_waist = np.std(cintura)
print(f"Desviación estándar de los datos de la cintura: {std_dev_waist}")

# Varianza de los datos de cintura
variance_waist = np.var(cintura)
print(f"Varianza de los datos de la cintura: {variance_waist}")

# Máximo y mínimo de los datos de cintura
max_val_waist = np.max(cintura)
min_val_waist = np.min(cintura)
print(f"Máximo de los datos de la cintura: {max_val_waist}, Mínimo de los datos de la cintura: {min_val_waist}")

# Percentiles de los datos de cintura
percentile_25_waist = np.percentile(cintura, 25)
percentile_75_waist = np.percentile(cintura, 75)
print(f"Percentil 25 de los datos de la cintura: {percentile_25_waist}, Percentil 75 de los datos de la cintura: {percentile_75_waist}")

# Histograma de los datos de cintura
